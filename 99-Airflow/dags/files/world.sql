...
-- COPY country (code, name, continent, region, surfacearea, indepyear, population, lifeexpectancy, gnp, gnpold, localname, governmentform, headofstate, capital, code2)
-- FROM '/tmp/dump/data_country.csv'
...
-- COPY countrylanguage (countrycode, "language", isofficial, percentage)
-- FROM '/tmp/dump/data_country_lang.csv'
